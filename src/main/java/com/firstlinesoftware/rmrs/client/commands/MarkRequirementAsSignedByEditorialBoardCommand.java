...
public class MarkRequirementAsSignedByEditorialBoardCommand extends BrowserCommand<DTO> {
    ...
    public Widget getInstance(final Browser<DTO> view) {
        button = createButton(messages.signedByEditorialBoard(), new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                ...
                StandardPopups.enterValue(new AutoLayoutTextArea(), messages.comment(), null, button, new SuccessCallback<String>() {
                    ...
                    public void onSuccess(String comment) {
                        ...
                        requirementProxy.setLifecycle(Requirement.LIFECYCLE_SIGNED, ids, comment, new VoidUserActionCallback(
